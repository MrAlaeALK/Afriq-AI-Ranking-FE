...
export default function RadarChartDisplay({ chartData, countryData }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md mb-8 text-gray-900 dark:text-gray-100">
      ...
      <div ref={containerRef}>
        <h2 className="text-xl font-semibold mb-4">{t('scorePerIndice')}</h2>
