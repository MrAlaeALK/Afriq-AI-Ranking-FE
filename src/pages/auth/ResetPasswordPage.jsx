...
const ResetPasswordPage = () => {
    ...
    const { resetPassword, verifyResetToken, errorMessage } = useAuth()
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <input
                                    ...
                                    className={`appearance-none relative block w-full px-3 py-2 border ${errors.newPassword ? 'border-red-300' : 'border-gray-300'
